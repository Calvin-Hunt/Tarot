...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'cosmic-grid':
          'radial-gradient(circle at center, rgba(212,176,106,0.08) 0, transparent 38%), linear-gradient(rgba(255,255,255,0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(255,255,255,0.03) 1px, transparent 1px)',
      },
      animation: {
